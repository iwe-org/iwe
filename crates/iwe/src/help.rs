...
pub mod paths {
    pub const ABOUT: &str = include_str!("../help/paths/about.txt");
    pub const LONG_ABOUT: &str = include_str!("../help/paths/long_about.txt");
    pub const AFTER_HELP: &str = include_str!("../help/paths/after_help.txt");
}
...
pub mod contents {
    pub const ABOUT: &str = include_str!("../help/contents/about.txt");
    pub const LONG_ABOUT: &str = include_str!("../help/contents/long_about.txt");
    pub const AFTER_HELP: &str = include_str!("../help/contents/after_help.txt");
}
